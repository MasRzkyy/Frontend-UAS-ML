...
export default function XGBoostDiabetesPage() {
  ...
  const handlePredict = async () => {
    ...
    try {
      ...
      const response = await fetch(
        "https://web-production-39361.up.railway.app/api/predict-xgb",
        {
          method: "POST",
      ...
      <div className="max-w-4xl mx-auto my-10   p-8 bg-white rounded-2xl shadow-md border">
        ...
        <div className="mt-6 p-4 bg-orange-50 rounded-xl border border-orange-200">
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-2">
            <input
              ...
              placeholder="Contoh: 4, 110, 92, 0, 0, 37.6, 0.191, 30"
              className="flex-1 border border-orange-300 rounded-lg p-3 text-gray-800 
            ...
            <button
              ...
              className="w-full sm:w-auto px-4 py-3 bg-orange-600 text-white rounded-lg 
                 hover:bg-orange-700 whitespace-nowrap"
            >
              Isi Kolom
            </button>
          </div>
          ...
          {FIELD_NAMES.map((field) => (
            <div key={field} className="flex flex-col">
              ...
              <input
                ...
                required
                className="border border-[#cfd8dc] bg-[#f8fbff] p-3 rounded-lg text-gray-800 focus:outline-none focus:ring-2 focus:ring-orange-500"
        ...
        <div className="flex justify-end mt-10 gap-4">
          ...
          <button
            ...
            disabled={loading}
            className="px-8 py-3 bg-orange-700 text-white rounded-lg hover:bg-orange-800"
          >
            {loading ? "Memproses..." : "Prediksi dengan XGBoost"}
          </button>
        </div>
      </div>
      ...
      {result && (
        ...
        >
          ...
          >
            ...
            {/* ✅ Bagian Metrik Tambahan (dengan fallback) */}
            {(result.performa_model.precision ||
              result.performa_model.recall ||
              result.performa_model.f1_score) && (
            ...
            <div className="mt-6 flex justify-center">
              <button
                onClick={() => setResult(null)}
                className="px-6 py-2.5 bg-orange-600 text-white font-medium rounded-lg hover:bg-orange-700 transition"
              >
                Tutup
              </button>
            </div>
